          ...
          return (
            <div
              ...
              className={`p-3 rounded-xl border text-xs space-y-2 transition-all ${
                isSelected
                  ? 'bg-[#0F172A] border-cyan-500 shadow-md shadow-cyan-500/10'
                  : 'bg-[#080E1A] border-gray-800/80 hover:border-gray-700'
              }`}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {isSelected && (
                    <span className="text-[9px] px-1.5 py-0.5 bg-cyan-500/20 text-cyan-300 font-bold rounded border border-cyan-500/40">
                      ACTIVE IN TERMINAL
                    </span>
                  )}
                </div>
              ...
              <div className="flex items-center justify-between pt-1 border-t border-gray-800/60">
                ...
                <div className="flex items-center gap-1.5">
                  {onSelectBot && (
                    ...
                    >
                      {isSelected ? 'Selected' : 'Swap to Bot'}
                    </button>
                  )}
                  <button
