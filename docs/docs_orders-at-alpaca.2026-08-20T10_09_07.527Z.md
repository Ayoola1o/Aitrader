...
# Buying Power   [Skip link to Buying Power](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#buying-power)
...
# Equities Trading   [Skip link to Equities Trading](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#equities-trading)

The following section deals with equity trading

## Orders Submitted Outside of Eligible Trading Hours   [Skip link to Orders Submitted Outside of Eligible Trading Hours](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#orders-submitted-outside-of-eligible-trading-hours)
...
## Extended Hours Trading   [Skip link to Extended Hours Trading](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#extended-hours-trading)
...
### Submitting an Extended Hours Eligible Order   [Skip link to Submitting an Extended Hours Eligible Order](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#submitting-an-extended-hours-eligible-order)
...
## IPO Symbols   [Skip link to IPO Symbols](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#ipo-symbols)
...
# Order Types   [Skip link to Order Types](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#order-types)
...
## Market Order   [Skip link to Market Order](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#market-order)
...
## Limit Order   [Skip link to Limit Order](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#limit-order)
...
### Sub-penny increments for limit orders   [Skip link to Sub-penny increments for limit orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#sub-penny-increments-for-limit-orders)
...
## Stop Orders   [Skip link to Stop Orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#stop-orders)
...
### Sub-penny increments for stop orders   [Skip link to Sub-penny increments for stop orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#sub-penny-increments-for-stop-orders)
...
## Stop Limit Order   [Skip link to Stop Limit Order](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#stop-limit-order)
...
## Opening and Closing Auction Orders   [Skip link to Opening and Closing Auction Orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#opening-and-closing-auction-orders)

Market on open and limit on open orders are only eligible to execute in the opening auction. Market on close and limit on close orders are only eligible to execute in the closing auction. Please see the [Time in Force](https://docs.alpaca.markets/us/docs/orders-at-alpaca#time-in-force) section for more details.

## Bracket Orders   [Skip link to Bracket Orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#bracket-orders)
...
## OCO Orders   [Skip link to OCO Orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#oco-orders)
...
## OTO Orders   [Skip link to OTO Orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#oto-orders)
...
### Threshold on stop price of stop-loss orders   [Skip link to Threshold on stop price of stop-loss orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#threshold-on-stop-price-of-stop-loss-orders)
...
## Trailing Stop Orders   [Skip link to Trailing Stop Orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#trailing-stop-orders)
...
### Notional Order Restrictions   [Skip link to Notional Order Restrictions](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#notional-order-restrictions)
...
# Time in Force   [Skip link to Time in Force](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#time-in-force)

> 🚧
>
> ### Crypto Time in Force   [Skip link to Crypto Time in Force](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#crypto-time-in-force)
>
...
## Aged order policy   [Skip link to Aged order policy](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#aged-order-policy)
...
## Order Types vs Supported Time in Force   [Skip link to Order Types vs Supported Time in Force](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#order-types-vs-supported-time-in-force)

This section contains the tables showing time-in-force options for various order types.

**_Note_** _: Please contact the sales team for any TIF marked with a\*_ .

### Whole qty orders (USD)   [Skip link to Whole qty orders (USD)](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#whole-qty-orders-usd)
...
### Fractional orders (USD)   [Skip link to Fractional orders (USD)](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#fractional-orders-usd)
...
### LCT (Whole qty or Fractional)   [Skip link to LCT (Whole qty or Fractional)](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#lct-whole-qty-or-fractional)
...
### Extended Hours orders   [Skip link to Extended Hours orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#extended-hours-orders)
...
### Crypto orders   [Skip link to Crypto orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#crypto-orders)
...
### OTC Assets   [Skip link to OTC Assets](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#otc-assets)
...
### Options Orders   [Skip link to Options Orders](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#options-orders)
...
# Order Lifecycle   [Skip link to Order Lifecycle](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#order-lifecycle)
...
# Odd Lots and Block Trades   [Skip link to Odd Lots and Block Trades](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#odd-lots-and-block-trades)
...
# Short Sales   [Skip link to Short Sales](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#short-sales)
...
# Order Handling Standards at Alpaca Securities LLC   [Skip link to Order Handling Standards at Alpaca Securities LLC](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#order-handling-standards-at-alpaca-securities-llc)
...
# OTC Positions   [Skip link to OTC Positions](https://docs.alpaca.markets/us/docs/orders-at-alpaca\#otc-positions)
