...
import { MarketSnapshot, SymbolId, LLMDecision, Position, PortfolioState } from '@/types/trading';
import { InteractiveChart } from './InteractiveChart';
import { TrendingUp, ArrowUpRight, ArrowDownRight, Layers, ShoppingBag, Clock, Wallet } from 'lucide-react';
          ...
          <div>
            ...
            <div className="p-2.5 mb-3 bg-[#0B111E] rounded-xl border border-gray-800 text-[11px] space-y-1">
              ...
              <div className="flex justify-between text-gray-400">
                ...
                <strong className="text-emerald-400">${(portfolio.freeMargin || portfolio.equity).toLocaleString()}</strong>
              </div>
            </div>
